...
Batch proposals require an actual nonempty array of operation objects with
supported actions and target names. Encoded or malformed strings are rejected
